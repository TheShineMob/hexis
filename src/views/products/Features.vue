<template>
  <div id="features" >
    <div class="container">
      <el-row id="mainTitle" type="flex">
        <el-col :xl="24" :xs="24"><h1 style="font-size: 42px; margin-bottom: 35px;">特性</h1></el-col>
      </el-row>
      <el-row>
        <el-col :xs="24" :xl="12" :lg="12" :md="12" :sm="12" >
          <wrapper video-title-black-p="自修复"
                   poster-p="505803090.webp"
                   video-url-p="HEXIS–Carprotectionfilm-SelfHealing-BODYFENCE.mp4"
          ></wrapper>
...
<!--          text-box3-p="由于太阳的热或仅使用热水冲洗，所有这些划痕都将会从BODYFENCE保护膜的表面消除，您原来的油漆被保存了......永远年轻！"-->
        ...
        <el-col :xs="24" :xl="12" :lg="12" :md="12" :sm="12">
          <wrapper video-title-black-p="极强抗刮擦"
                   poster-p="657817812.webp"
                   video-url-p="BODYFENCE-WhyyouneedtouseBODYFENCE-.mp4"
          ></wrapper>
...
<!--          text-box1-p="从石头，砂石到道路残渣，油漆损坏的原因有上百万种。借助<b>BODYFENCE</b>抵御这些日常道路危害得影响。"-->
      ...
      <el-row>
        <el-col :xs="24" :xl="12" :lg="12" :md="12" :sm="12">
          <wrapper video-title-black-p="自我清洁"
                   poster-p="505791842.webp"
                   video-url-p="HEXIS–Protectyourpaint-SelfCleaning-BODYFENCE.mp4"
          ></wrapper>
...
<!--          text-box2-p="清洁频率将降低，并且清洁起来更容易。"-->
        ...
        <el-col :xs="24" :xl="12" :lg="12" :md="12" :sm="12">
          <wrapper video-title-black-p="超亮度"
                   poster-p="657817897.webp"
                   video-url-p="HEXISDecoration-Glassfilms.mp4"
          ></wrapper>
...
<!--          text-box2-p="该膜有亮光和哑光两种膜面可供选择，哑光版的<strong><span style='color: #de0022;'>HEXIS</span> BODYFENCE</strong> 可以使任何油漆或光泽膜哑光。"-->
    ...
    <el-row>
      <el-col>
        <more-view :show-more-position-p="false"
                   more-background-url-p="bodyfenceBrut1080.jpg"
                   more-title-top-p="BODYFENCE MATT"
                   more-url-p="/bodyFenceMatt"
        ></more-view>
      </el-col>
    </el-row>
  </div>
...
<script>
  import Wrapper from "@/views/products/childComponents/Wrapper";
  import MoreView from "@/views/products/childComponents/MoreView";
  export default {
    name: "Features",
    components: {
      Wrapper,
